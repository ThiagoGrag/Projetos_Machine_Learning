...
# Classificação KNN em R - Problema Para Classificação Binária
...
setwd("~/DataScienceStructure/Machine_Learning/Cap06")
getwd() 
...
View(indxTrain)
dados_treino <- Smarket[indxTrain,] # Todas as linhas com o índice e todas as colunas 
...
scale.features <- function(df, variables){  ## A função requer os dados de DF e as variáveis VARIABLES
...
dados_treino_scaled <- scale.features(dados_treino, numeric.vars_treino)  ## Aqui passo os dois dados que precisam
